    ...
    <ul class="short-filter clearfix">
        ...
        <li>
            <select class="form-control selectpic" onchange="if(this.value!='')javascript:location.href = this.value;">
                  ...
                  <option value="<?=base_url()?>clients/all/companyname/asc/sort/<?=$page?>">Company</option>
                  <option value="<?=base_url()?>clients/all/firstname/desc/sort/<?=$page?>">Job Posted</option>
                  <option value="">Jobs Filled</option>
                  <option value="<?=base_url()?>clients/all/state/asc/sort/<?=$page?>">Location</option>
                  <option value="">Account Status</option>
                  <option value="<?=base_url()?>clients/all/activated/desc/sort/<?=$page?>">Status</option>
        ...
        <li>
            <select class="form-control selectpic" onchange="if(this.value!='')javascript:location.href = this.value;">
                ...
                <option value="<?=base_url()?>clients/all/activated/1/where/<?=$page?>">Active Accounts</option>
                <option value="<?=base_url()?>clients/all/activated/0/where/<?=$page?>">Inactive Accounts</option>
        ...
        <table width="100%" border="0">
            ...
            foreach ($clients as $client) { ?>
                <tr>
                    ...
                    <td> 0.0 </td>
                    <td> <img class="img-circle" width="33" height="33" alt="" src="<?=$client->avatar=='' ? base_url().'resource/avatar/default.jpg' : base_url().'resource/avatar/'.$client->avatar ?>">  </td>
