        ...
        <div class="wa3-form">
                    ...
                    <div class="skill-sec clearfix">
                        <div data-toggle="buttons" class="btn-group">
                            <label class="btn btn-primary">
                                ...
                                <span class="txt-cha1">barista </span> <input type="radio" name="uniform" value="Barista" autocomplete="off"> 
                            </label>
                            <label class="btn btn-primary">
                                <div class="skill-select-pic">
            ...
            <div class="row wa3-form-row">
                <div class="col-md-6">
                    ...
                    <input type="hidden" name="hrate" id="hrate" value="<?=$hourlyrate?>">
                    <div class="input-group">
                    <div class="input-group-addon">$</div>
                    <input type="text" class="form-control" name="hourlyrate" id="hourlyrate" placeholder="hourly rate" value="<?=$hourlyrate?>" disabled>
