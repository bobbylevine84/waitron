<div class="container">
    ...
    <ul class="acc-dec job-payment">
        <li><a href="<?=base_url()?>client/reports">jobs</a></li>
        <li><a class="active" href="<?=base_url()?>client/reports/invoices">invoices</a></li>
    </ul>
    <div class="jobs">
            ...
            <table class="table table-hover" width="100%" border="0">
              ...
              <tbody>
                  ...
                  <!-- <tr>
                    ...
                    <td>$4200</td>
                    <td>9/27/15</td>
                    <td><span class="txt-paid">paid</span></td>
                    <td> <a href="javascript:void(0)"> <u>view invoice</u> </a> </td>
                  </tr>
                  <tr>
                    <td>10012801</td>
                    <td>samsung event</td>
