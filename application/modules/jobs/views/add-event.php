        ...
        <div class="wa3-form">
              <div class="row wa3-form-row">
                  <div class="col-md-6">
                    ...
                    <select name="createdby" id="client" class="form-control select-form" required onchange="if(this.value!='')gethr(this.value);">
              ...
              <script type="text/javascript">
                  ...
                  function addservices(services)
                  {
                      ...
                      if(hrate=='')
                      {
                          ...
                          {
                              $(services).parent(".label-item").removeClass('active');
                          }
                          alert('please first select client');
                          $('html, body').animate({
              ...
              <div class="select-skill">
                  <div class="text-center">
                      <div data-toggle="buttons" class="btn-group">
                          <?php foreach ($servicetype as $service) {  ?>  
                              <label class="btn btn-primary label-item">
              ...
              <div class="row wa3-form-row">
                  <div class="col-md-12">
                      ...
                      <textarea placeholder="2000 character note" name="note" class="form-control txt-fieldarea" required></textarea>
                  </div>
              </div>
