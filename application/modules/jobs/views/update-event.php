        ...
        <div class="wa3-form">
              <div class="row wa3-form-row">
                  ...
                  <div class="col-md-6">
                      ...
                      <input type="text" name="projectname" placeholder="project name" class="form-control" value="<?=$getevent->projectname?>" required>
                  </div>
              </div>
              ...
              <div class="row wa3-form-row">
                  <div class="col-md-6">
                      ...
                      <input type="text" name="contactperson" placeholder="contact person" class="form-control" value="<?=$getevent->contactperson?>" required>
                  </div>
                  <div class="col-md-6">
                      <label class="label-txt">phone number</label>
                      <input type="text" name="phonenumber" placeholder="phone number" class="form-control" value="<?=$getevent->phonenumber?>" required>
                  </div>
              </div>
              ...
              <div class="row wa3-form-row">
                  <div class="col-md-6">
                      ...
                      <input type="text" name="zipcode" placeholder="zip code" class="form-control" value="<?=$getevent->zipcode?>" required>
                  </div>
                  <div class="col-md-6">
                      <label class="label-txt">city</label>
                      <input type="text" name="city" placeholder="city" class="form-control" value="<?=$getevent->city?>" required>
                  </div>
              </div>
              ...
              <div class="row wa3-form-row">
                  <div class="col-md-6">
                      ...
                      <input type="text" name="state" placeholder="state" class="form-control" value="<?=$getevent->state?>" required>
                  </div>
                  <div class="col-md-6">
                      <label class="label-txt">address</label>
                      <input type="text" name="address" placeholder="address" class="form-control" value="<?=$getevent->address?>" required>
                  </div>
              </div>
                        ...
                        <div class="skill-sec clearfix">
                            <div data-toggle="buttons" class="btn-group">
                                <label class="btn btn-primary <?=$service->uniform=='Barista' ? 'active' : ''?>">
                                    ...
                                    <span class="txt-cha1">barista </span> <input type="radio" name="uniform<?=$j?>" value="Barista" required <?=$service->uniform=='Barista'? 'checked' : ''?> disabled> 
                                </label>
                                <label class="btn btn-primary <?=$service->uniform=='Waiter White'? 'active' : ''?>">
                                    <div class="skill-select-pic">
                                        <img alt="" src="<?=base_url()?>resource/images/wa32.png">
                                    </div>
                                    <span> waiter white </span> <input type="radio" name="uniform<?=$j?>" value="Waiter White" required <?=$service->uniform=='Waiter White'? 'checked' : ''?> disabled> 
                                </label>
                                <label class="btn btn-primary <?=$service->uniform=='All Black' ? 'active' : ''?>">
                                   <div class="skill-select-pic">
                                        <img alt="" src="<?=base_url()?>resource/images/wa33.png">
                                    </div>
                                    <span class="txt-cha2"> all black </span> <input type="radio" name="uniform<?=$j?>" value="All Black" required <?=$service->uniform=='All Black' ? 'checked' : ''?> disabled> 
                                </label>
                            </div>
                        </div>        
                    </div>
              ...
              <div class="row wa3-form-row">
                  <div class="col-md-12">
                      ...
                      <textarea placeholder="2000 character note" name="note" class="form-control txt-fieldarea" required><?=$getevent->note?></textarea>
                  </div>
              </div>

              <div class="we9-heading">total positions: <span class="txt-clr">0</span></div>
              <div class="row wa3-form-row">
                  <div class="col-md-12">
                      <div class="blu-box">
              ...
              <div class="row wa3-form-row">
                  <div class="col-md-12">
                      <div class="text-center"> <input type="submit" name="updateevent" class="submit-btn" value="submit"> </div>
                  </div>
              </div>
        </div>        
    </form>
