            ...
            <div class="wa3-form">
                ...
                <div class="row wa3-form-row">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="projectname" value="<?=$job->projectname?>" placeholder="project name" class="form-control" required>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row wa3-form-row">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="zipcode" value="<?=$job->zipcode?>" placeholder="zip code" class="form-control" required>
                    </div>
                    <div class="col-md-6">
                        <label class="label-txt">city</label>
                        <input type="text" name="city" value="<?=$job->city?>" placeholder="city" class="form-control" required>
                    </div>
                </div>
                ...
                <div class="row wa3-form-row">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="state" value="<?=$job->state?>" placeholder="state" class="form-control" required>
                    </div>
                    <div class="col-md-6">
                        <label class="label-txt">address</label>
                        <input type="text" name="address" value="<?=$job->address?>" placeholder="address" class="form-control" required>
                    </div>
                </div>
                ...
                <div class="row wa3-form-row">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="contactperson" value="<?=$job->contactperson?>" placeholder="contact person" class="form-control" required>
                    </div>
                    <div class="col-md-6">
                        <label class="label-txt">phone number</label>
                        <input type="text" name="phonenumber" value="<?=$job->phonenumber?>" placeholder="phone number" class="form-control" required>
                    </div>
                </div>
                ...
                <div class="row wa3-form-row">
                    <div class="col-md-12">
                        ...
                        <textarea placeholder="2000 character note" name="note" class="form-control txt-fieldarea"><?=$job->note?></textarea>
                    </div>
                </div>
                
                <div class="row wa3-form-row">
                    <div class="col-md-12">
                        <div class="text-center"> <input type="submit" name="updatejob" value="submit" class="submit-btn"> </div>
                    </div>
                </div>    
            </div>        
        </form>
